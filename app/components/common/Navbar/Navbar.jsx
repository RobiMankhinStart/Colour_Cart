...
export default function Navbar() {
  return (
    <nav className="hidden md:flex font-semibold justify-between items-center">
      ...
      {/* Menu */}
      <ul className="flex text-[#989898] items-center gap-[52px]">
        <li className="hover:text-black text-[20px] font-medium">
          <Link href="/">Home</Link>
        </li>
        <li className="hover:text-black text-[20px] font-medium">
      ...
      {/* Icons */}
      <div className="flex items-center gap-6">
        <IoMdHeartEmpty className="text-[32px] cursor-pointer hover:text-[#989898] hover:scale-110 duration-200" />

        <Link href="/ShoppingCart">
          <IoCartOutline className="text-[32px] cursor-pointer hover:text-[#989898] hover:scale-110 duration-200" />
        </Link>

        <Link href="/login">
          <FiUser className="text-[32px] cursor-pointer hover:text-[#989898] hover:scale-110 duration-200" />
        </Link>
      </div>
    </nav>
  );
