...
const page = () => {
  ...
  const products = [
    ...
    {
      id: 2,
      title: "Philips wireless head phone",
      price: 767.5,
      qty: 3,
      total: 767.5,
      img: "/prod2.png",
    ...
    <div className="w-full p-6 bg-background min-h-screen rounded-xl">
      ...
      <div className="mt-2 space-y-2">
        {products.map((p, idx) => (
          ...
          >
            ...
            <div className="w-24 text-center">${p.price.toFixed(2)}</div>
            <div className="w-24 text-center">{p.qty}</div>
            <div className="w-24 text-right">${p.total.toFixed(2)}</div>
      ...
      <div className="flex justify-end mt-6">
        <div className="bg-white p-4 rounded-lg shadow w-64 space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            <span>Tax (20%):</span>
            <span className="font-medium">$782.01</span>
          </div>
          <div className="flex justify-between">
            <span>Discount:</span>
            <span className="font-medium">$293.01</span>
          </div>
          <hr />
